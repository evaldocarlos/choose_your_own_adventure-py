...
answer = input(
    "You are on a dirt road, it has come to an end and you can go left or right. Wich way would you like to go? ").lower()
...
if answer == "left":
    ...
    if answer == "back":
        ...
        if answer == "yes":
            ...
            print("You ignore the stranger and they are offended and yiu lose.")
        else:
            print('Not a valid optio. You lose.')
    else:
        print('Not a valid optio. You lose.')
